...
public class CommandCenter {
	...
	protected List<Movable> movDebris = new ArrayList<Movable>(300);
	protected List<Movable> movFriends = new ArrayList<Movable>(100);
	protected List<Movable> movFoes = new ArrayList<Movable>(200);
	protected List<Movable> movFloaters = new ArrayList<Movable>(50);
