...
public class GamePanel extends Panel {
	...
	private void drawScore(Graphics g) {
		...
		if (CommandCenter.getInstance().getScore() != 0) {
			g.drawString("SCORE :  " + CommandCenter.getInstance().getScore()+"           LEVEL : " + CommandCenter.getInstance().getLevel() +
					"           SHIELD : " + CommandCenter.getInstance().getFalcon().getShield()+"           Falcon : " + CommandCenter.getInstance().getNumFalcons(), nFontWidth, nFontHeight);
